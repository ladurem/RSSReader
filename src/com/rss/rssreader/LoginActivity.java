...
public class LoginActivity extends Activity {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			HttpGet request = new HttpGet("http://mladure.rmorpheus.enseirb.fr/FluxRSS/appli/user/add/"+mLogin+"/"+mPassword);
		...
		protected void onPostExecute(String result) {
			...
			if(result.toString().contentEquals("OK")){
				...
				prefs.edit().putString("login", mLogin).commit();
				...
				mEmailView.setError("Login indisponible");
